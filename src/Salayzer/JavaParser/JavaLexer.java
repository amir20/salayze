package Salayzer.JavaParser;// $ANTLR 2.7.5 (20050128): "java.g" -> "Salyze.JavaParser.JavaLexer.Lexer.JavaLexer.java"$
...
public class JavaLexer extends antlr.CharScanner implements JavaTokenTypes, TokenStream {
    ...
    public JavaLexer(LexerSharedInputState state) {
        ...
        literals.put(new ANTLRHashString("class", this), new Integer(104));
        ...
        literals.put(new ANTLRHashString("super", this), new Integer(74));
        ...
        literals.put(new ANTLRHashString("default", this), new Integer(102));
    ...
    public final void mML_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
        ...
        match("/*");
        {
            ...
            do {
                ...
                if ((LA(1) == '\r') && ((LA(2) >= '\u0003' && LA(2) <= '\u7ffe')) && ((LA(3) >= '\u0003' && LA(3) <= '\u7ffe')) && (true)) {
                    match('\r');
                    if (inputState.guessing == 0) {
                        newline();
                    }
